...
$highlighted = 'APP_TIMEZONE';
// Open the file in Visual Studio Code
function openFileInVSCode($filePath, $lineNumber) {
    // Sanitize inputs
    ...
    echo "Executing command: $openCommand \n";
...
if (file_exists($envFilePath)) {
    ...
    // Find the line number for the updated text
    $lineNumber = findLineNumberInFile($envFilePath, $highlighted); // Get the first element of the array

    if ($lineNumber !== false) {
        openFileInVSCode($envFilePath, $lineNumber);
    } else {
